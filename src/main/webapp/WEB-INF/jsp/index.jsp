...
<html lang="cs">
	...
	<body style="height: 100vh;overflow: auto;" data-theme="light">
		...
		<h2>Java-like dědičnost přes qpx.Class</h2>
		<section style="padding:16px;">
		...
		$(function () {
		        ...
		        items: [
		            // -- before (levá strana) --
		            {
		                ...
		                options: {
		                    ...
		                    onClick: function (e) { log("Button 'Menu' — click (itemIndex přes toolbar.onItemClick)."); }
		                }
		            },
		            {
		            ...
		            },
		            {
		                ...
		                options: {
		                    ...
		                    onClick: function (e) { log("Button 'Nový' — vytvářím záznam..."); }
		                }
		            },
		            {
		                ...
		                options: {
		                    ...
		                    onItemClick: function (e) { log("ButtonGroup — kliknuta položka: " + e.itemData.text); }
		                }
		            },
		            {
		                location: "before", widget: "dropDownButton",
		                options: {
		                    text: "Export", icon: "⭳", splitButton: true,
		                    items: [
		                        { text: "Export do PDF", key: "pdf" },
		                        { text: "Export do Excelu", key: "xlsx" },
		                        { text: "Export do CSV", key: "csv" }
		                    ],
		                    onButtonClick: function (e) { log("DropDownButton 'Export' — hlavní tlačítko kliknuto."); },
		                    onItemClick: function (e) { log("DropDownButton 'Export' — vybráno: " + e.itemData.text); }
		                }
		            },
		            {
		                location: "before", widget: "button",
		                options: { text: "Uložit", type: "success",
		                    onClick: function (e) { log("Button 'Uložit' — ukládám..."); } }
		            },
		            {
		                location: "before", widget: "button",
		                options: { text: "Smazat", type: "danger",
		                    onClick: function (e) { log("Button 'Smazat' — mažu záznam..."); } }
		            },
		            {
		                location: "before", widget: "button",
		                options: { text: "Filtr", stylingMode: "outlined",
		                    onClick: function (e) { log("Button 'Filtr' — otevírám filtr..."); } }
		            },
		            {
		                location: "before", widget: "button",
		                options: { text: "Tisk", stylingMode: "outlined",
		                    onClick: function (e) { log("Button 'Tisk' — tisknu..."); } }
		            },
		            ...
		            // -- after (pravá strana) --
		            {
		                ...
		                options: { icon: "🔔", stylingMode: "text", hint: "Notifikace",
		                    onClick: function (e) { log("Button 'Notifikace' — click."); } }
		            },
		            {
		                location: "after", widget: "dropDownButton", locateInMenu: "never",
		                options: {
		                    text: "Petr Novák", icon: "👤",
		                    items: [
			...
			qpx.ui({
				rows: [{
					...
					{
						cols: [{ 
							view: "template", width: 180, css: "sidebar", template: "<div style='padding:12px;'>Postranní panel<br>(pevná šířka 180px)</div>" 
						}, { 
			...
			//    (qpx.parse() proběhne samo, viz src/qpx.parser.js)
			// ------------------------------------------------------------
			
			// ------------------------------------------------------------
			// Class systém — Java-like dědičnost
			// ------------------------------------------------------------
